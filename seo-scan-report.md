...
- נסרקו **196 עמודי HTML** בסך הכול.
- מתוכם **184 עמודים אינדקסביליים** ו-12 עמודי `noindex`/הפניה.
- `title`: תקין ב-184 עמודים אינדקסביליים.
- `meta description`: תקין ב-184 עמודים אינדקסביליים.
- `canonical`: תקין ב-184 עמודים אינדקסביליים.
- `og:image`: תקין ב-184 עמודים אינדקסביליים.
- Schema (`ld+json`): תקין ב-184 עמודים אינדקסביליים.
- `h1`: תקין ב-184 עמודים אינדקסביליים.
- `sitemap.xml`: כולל 188 כתובות URL.
